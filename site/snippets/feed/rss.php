...
echo '<?xml version="1.0" encoding="utf-8"?>'; ?><rss version="2.0">
  <channel>
    ...
    <item>
      ...
      <pubDate><?= $datefield === 'modified'
      	? $item->modified('r', 'date')
      	: date('r', $item->{$datefield}()->toTimestamp()) ?></pubDate>
      <description><![CDATA[<?= $item->text()->isEmpty()
      	? $item->content()->content()->toBlocks()
      	: $item->text()->kt() ?>]]></description>
    </item>
    <?php } ?>
  </channel>
</rss>
